	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span12">
				...
				<form:form class="form-horizontal" action="users/actionTest" method="POST" modelAttribute="Product"  name="productForm" id="productForm">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" path="image" name="image" id="image" title="Image" value="">
						</div>
					</div>
